...
execute if score limit rayData matches 1..400 if block ~ ~ ~ #minecraft:slabs[type=bottom] if score slab_height rayData matches 51.. run function lobby:railgun/ray
execute if score limit rayData matches 1..400 if block ~ ~ ~ #minecraft:slabs[type=top] if score slab_height rayData matches ..50 run function lobby:railgun/ray